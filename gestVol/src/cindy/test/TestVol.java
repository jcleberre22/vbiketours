...
import cindy.paqMetier.personnel.PersonnelNaviguant;
import cindy.paqMetier.vol.Armement;
import cindy.paqMetier.vol.Avion;
import cindy.paqMetier.vol.Mission;
import cindy.paqMetier.vol.SortieAerienne;
import cindy.paqMetier.vol.Vol;
import cindy.paqMetier.vol.Evenement;

import junit.framework.TestCase;

/**
 * classe de Test Effectue des
 * tests JUnit sur le vol
 * @author J.Martinez Version 1.0 du 26.07.2011 
 */
public class TestVol extends TestCase {
	...
	Equipage equipage = new Equipage(new PersonnelNaviguant(),
			new PersonnelNaviguant());
	...
	protected void setUp() throws Exception {
		monVol = new Vol("A41D", "civile", 1, listSortiesAeriennes, new GregorianCalendar(2011,5,12),new GregorianCalendar(2011,5,28));
		sa = new SortieAerienne(avion, chaine, arm, lst, equipage, mission,
				new GregorianCalendar(2011,5,12), new GregorianCalendar(2011,5,28));
	}
	...
	public void testerConstructeurVol() {
		try {
			new Vol("A56GF", "transport", 1, listSortiesAeriennes, new GregorianCalendar(2011,5,12),
					new GregorianCalendar(2011,5,28));
	 ...
	 */
	 ...
	 assertTrue("la déclaration a marché malgré la valeur null : " +
	 e.getMessage(),true);
	 }
	 }
	 ...
	 */
	 ...
	 try {
	 SortieAerienne newSortie = new SortieAerienne(new
	 Avion("75df4","combat","Mirage2000N",true),null,new Armement(),null,new
	 Equipage(new PersonnelNaviguant()),new Mission("type","description"),new
	 ...
	 try {
	 SortieAerienne sortieNull = new
	 SortieAerienne(null,"mon debrif",null,lst,null,null,null,null);
